...
import com.example.testbook.databinding.ActivityDashboardUserBinding
...
class DashboardUserActivity : AppCompatActivity() {
    ...
    class ViewPagerAdapter(fm: androidx.fragment.app.FragmentManager, behavior: Int, context: Context): FragmentPagerAdapter(fm, behavior){
